...
async def start(message: types.Message, state: FSMContext):
    ...
    if start_param == 'prodazha':
        welcome_msg = "💰 <b>Отлично! Вы перешли из раздела продажи на сайте!</b>\n\n<b>Добро пожаловать!</b>\n\nХотите продать недвижимость быстро и дорого? Оставьте заявку — мы найдем покупателя за 14 дней! ✅ Бесплатная оценка ✅ Проверка документов ✅ Сопровождение сделкиЭтот помощник поможет вам оставить заявку на продажу недвижимости.\nПожалуйста, заполняйте все поля внимательно и максимально подробно, чтобы наши специалисты могли связаться с вами и помочь быстро и качественно."
    else:
...
@dp.message_handler(state=SaleForm.photos, content_types=['photo', 'text'])
